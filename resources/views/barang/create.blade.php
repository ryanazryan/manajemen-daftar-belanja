                        ...
                        <form method="post" action="{{ route('barang.store') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_barang" name="nama_barang" type="text"
                                    class="mt-1 block w-full" :value="old('nama_barang')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_per_satuan" name="harga_per_satuan" type="text"
                                    class="mt-1 block w-full" :value="old('harga_per_satuan')" placeholder="Rp 0" required />
                            ...
                            <div>
                                ...
                                <textarea id="keterangan" name="keterangan" rows="3"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('keterangan') }}</textarea>
